...
async def main():
    ...
    schedule = {
        time(17, 27): generate_and_queue_orders,
        time(17, 28): start_monitoring,
        time(17, 28): place_queued_orders,
        time(18, 0): close_all_open_positions,
        time(18, 30): cancel_and_stop_monitoring,
