...
schedule = {
    time(17, 0): start_monitoring,
    time(17, 2): generate_and_queue_orders,
    time(17, 4): place_queued_orders,
    time(16, 54): close_all_open_positions,
    time(16, 56): cancel_and_stop_monitoring,
    time(16, 57): analyze_and_archive
}
