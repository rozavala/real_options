...
schedule = {
    time(15, 10): start_monitoring,
    time(15, 12): generate_and_queue_orders,
    time(15, 14): place_queued_orders,
    time(14, 45): close_all_open_positions,
    time(14, 50): cancel_and_stop_monitoring,
    time(14, 55): analyze_and_archive
}
