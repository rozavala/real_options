...
5.  **State Management:** State reconciliation must group raw IBKR legs into semantic thesis groups and use aggregate quantities to avoid false-positive orphan detection. The system dynamically filters out superseded synthetic ledger entries when actual trades are discovered.
